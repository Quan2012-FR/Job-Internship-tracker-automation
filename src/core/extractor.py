...
from src.core.utils import canonicalize_company_name, extract_first_url, fallback_company_from_url, normalize_text
...
def extract_company_targets(path: str, mapping: WorkbookMapping) -> list[CompanyTarget]:
    ...
    for ws in wb.worksheets:
        ...
        for row_number, row in enumerate(rows, start=2):
            ...
            company = canonicalize_company_name(company)
